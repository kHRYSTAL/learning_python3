...
第二个参数是MIME的subtype，传入'plain'表示纯文本，最终的MIME就是'text/plain'，最后一定要用utf-8编码保证多语言兼容性。
'''
...
def sendEmailBySMTP():
    ...
    msg['From'] = 'jessicastam_love@163.com <jessicastam_love@163.com>'
    msg['Subject'] = Header(u'text', 'utf8').encode()
    msg['To'] = u'团长 <723526676@qq.com>'
    server = smtplib.SMTP('smtp.163.com', 25) # SMTP协议默认端口是25
    server.set_debuglevel(1)
    server.login('jessicastam_love@163.com', password)
    server.sendmail('jessicastam_love@163.com', ['liji0307@qq.com'], msg.as_string())
    server.quit()

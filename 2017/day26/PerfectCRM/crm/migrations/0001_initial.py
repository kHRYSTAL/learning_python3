# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-03-21 09:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseContent', models.TextField(max_length=1024, verbose_name='上课内容')),
                ('has_homework', models.BooleanField(default=True)),
                ('homework_title', models.CharField(blank=True, max_length=128, null=True)),
                ('homework_requirement', models.TextField(blank=True, max_length=128, null=True, verbose_name='作业需求')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.SmallIntegerField(choices=[(0, 'Badidu商桥'), (1, '51CTO'), (2, 'QQ群'), (3, '知乎'), (4, 'SOGO'), (5, '转介绍'), (6, '其他')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '绝无报名计划'), (1, '一个月内报名'), (2, '2周内报名'), (3, '已报名其他机构')])),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.SmallIntegerField(choices=[(100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (75, 'B-'), (70, 'C+'), (65, 'C'), (40, 'C-'), (-2, 'D'), (-50, 'COPY'), (0, 'N/A')])),
